	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_174_0 = ( IN.ase_texcoord8.z + saturate( 0.0 ) );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float temp_output_174_0 = ( IN.ase_texcoord3.z + saturate( 0.0 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_174_0 = ( IN.ase_texcoord2.z + saturate( 0.0 ) );
				float smoothstepResult171 = smoothstep( temp_output_174_0 , ( temp_output_174_0 + _ErosionSmoothness ) , tex2DNode11.g);
				float opacity175 = smoothstepResult171;
		...
		Pass
		{
						 ...
						 )
			{
				...
				float temp_output_174_0 = ( IN.ase_texcoord5.z + saturate( 0.0 ) );
				float4 tex2DNode11 = tex2D( _NoiseTexture, temp_output_14_0 );
				float smoothstepResult171 = smoothstep( temp_output_174_0 , ( temp_output_174_0 + _ErosionSmoothness ) , tex2DNode11.g);
				float opacity175 = smoothstepResult171;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_174_0 = ( IN.ase_texcoord.z + saturate( 0.0 ) );
...
Node;AmplifyShaderEditor.FunctionNode;163;-3968,1664;Inherit;False;RadialGradient;-1;;2;;0;0;0
...
ASEEND*/
//CHKSM=CEAE89DACAF01D2632F3EAE7FF15541674D42C9C